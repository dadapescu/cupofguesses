...
function NextMatchBanner({ match, now }) {
  ...
  let countdown;
  if (days > 0) countdown = `${days}z ${hours}h ${mm}m ${ss}s`;
  else countdown = `${hours}h ${mm}m ${ss}s`;
  ...
  return (
    <div style={{
      ...
      <span style={{
        fontFamily: "'Saira Condensed', monospace", fontSize: 20, fontWeight: 800,
        color: imminent ? C.gold : "#fff", letterSpacing: "0.02em", fontVariantNumeric: "tabular-nums",
      }}>
        {countdown}
      </span>
    </div>
